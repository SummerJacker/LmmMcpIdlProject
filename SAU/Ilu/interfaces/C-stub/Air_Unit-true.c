...
void Air_Unit__InitializeServer(void)
{
  ...
  _Air_Unit_rpc__DefaultClass = Air_Unit_rpc__MakeClass(
    server_Air_Unit_rpc_getCurrentSpeed,
    server_Air_Unit_rpc_getCurrentPose,
    server_Air_Unit_rpc_getCurrentInfo,
    server_Air_Unit_rpc_sendGimbalSpeed,
    server_Air_Unit_rpc_resetGimbal,
    server_Air_Unit_rpc_sendVehicleInfo,
    server_Air_Unit_rpc_reportTrap,
    server_Air_Unit_rpc_clearTraps,
    server_Air_Unit_rpc_getTraps,
    server_Air_Unit_rpc_setTrapPoint,
    server_Air_Unit_rpc_setTrack,
    server_Air_Unit_rpc_setTaskPath,
    server_Air_Unit_rpc_setTaskPoint,
    server_Air_Unit_rpc_clearTaskPoint,
    server_Air_Unit_rpc_obtainCtrlAuthority,
    server_Air_Unit_rpc_releaseCtrlAuthority,
    server_Air_Unit_rpc_setActionRole,
    server_Air_Unit_rpc_setActionMode,
    server_Air_Unit_rpc_setCruiseScope,
    server_Air_Unit_rpc_sendControlledVehicle,
    server_Air_Unit_rpc_confirmThrow,
    server_Air_Unit_rpc_cancelThrow,
    server_Air_Unit_rpc_actionThrow,
    server_Air_Unit_rpc_confirmFire,
    server_Air_Unit_rpc_cancelFire,
    server_Air_Unit_rpc_confirmFireLocation,
    server_Air_Unit_rpc_cancelFireLocation,
    server_Air_Unit_rpc_controlVehicleVelocity,
    server_Air_Unit_rpc_backHome,
    server_Air_Unit_rpc_setCruiseSpeed,
    server_Air_Unit_rpc_getID,
    server_Air_Unit_rpc_getCosNamingSBH,
    server_Air_Unit_rpc_getFrontUnitInfo,
    server_Air_Unit_rpc_setRole,
    server_Air_Unit_rpc_setMode,
    server_Air_Unit_rpc_setMinorMode,
    server_Air_Unit_rpc_sendMoveAction,
    server_Air_Unit_rpc_sendMoveActionSeq,
    server_Air_Unit_rpc_setALeader,
    server_Air_Unit_rpc_unregisterFollower,
    server_Air_Unit_rpc_setFollower,
    server_Air_Unit_rpc_unsetFollower,
    server_Air_Unit_rpc_addRearVehicle,
    server_Air_Unit_rpc_deleteRearVehicle,
    server_Air_Unit_rpc_setFormation,
    server_Air_Unit_rpc_setRearVehicles,
    server_Air_Unit_rpc_reportDeadVehicle,
    server_Air_Unit_rpc_shutDown,
    server_Air_Unit_rpc_startPhotoStream,
    server_Air_Unit_rpc_stopPhotoStream,
    server_Air_Unit_rpc_takePicture,
    0 /* no finalization */
    );
