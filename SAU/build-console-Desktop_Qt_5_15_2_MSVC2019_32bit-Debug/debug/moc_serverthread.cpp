...
#include <memory>
#include "../../Console/serverthread.h"
...
QT_MOC_LITERAL(1, 13, 15), // "bindInfoChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 8), // "bindInfo"
QT_MOC_LITERAL(4, 39, 12), // "infoAppended"
QT_MOC_LITERAL(5, 52, 4) // "info"

    },
    "ServerThread\0bindInfoChanged\0\0bindInfo\0"
    "infoAppended\0info"
};
...
void ServerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->bindInfoChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->infoAppended((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerThread::bindInfoChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ServerThread::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerThread::infoAppended)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ServerThread::bindInfoChanged(QString _t1)
{
...
// SIGNAL 1
void ServerThread::infoAppended(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
