...
win32 {
    ...
    win32-g++ {
        # ilu32*.lib 多为「32 位 + MSVC」产物；64 位 mingw64 的 ld 会 skipping incompatible 且找不到 libilu32.a
        ...
        # 不在此写 PRE_TARGETDEPS：MinGW 需 libilu32.a 等；若目录里只有 MSVC 的 .lib，写 .a 会导致 make 报错
    } else {
