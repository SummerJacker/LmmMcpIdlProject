...
void Console__InitializeServer(void)
{
  ...
  _Console_rpc__DefaultClass = Console_rpc__MakeClass(
    server_Console_rpc_getCosNamingInfo,
    server_Console_rpc_sendMsg,
    server_Console_rpc_bind,
    server_Console_rpc_unbind,
    server_Console_rpc_rebind,
    server_Console_rpc_setNickname,
    server_Console_rpc_setPosition,
    server_Console_rpc_addGoalPoint,
    server_Console_rpc_setGoalPoint,
    server_Console_rpc_setRole,
    server_Console_rpc_cancelRole,
    server_Console_rpc_setTrapPoint,
    server_Console_rpc_setFollow,
    server_Console_rpc_setFormationType,
    server_Console_rpc_setTrackMode,
    server_Console_rpc_getCurrentUnit,
    server_Console_rpc_getUnitNum,
    server_Console_rpc_getFormationNum,
    server_Console_rpc_getTrapNum,
    server_Console_rpc_getFormationType,
    server_Console_rpc_getFormationState,
    server_Console_rpc_getMissionState,
    server_Console_rpc_getUnitPoint,
    server_Console_rpc_getByName,
    server_Console_rpc_getLeaderPoint,
    server_Console_rpc_getPointSeq,
    server_Console_rpc_cancelFormation,
    server_Console_rpc_setLeaderSuspend,
    server_Console_rpc_recoveryLeaderAction,
    server_Console_rpc_addUnitFormation,
    server_Console_rpc_deleteUnitFormation,
    server_Console_rpc_setUnitFault,
    server_Console_rpc_setUnitFaultPosition,
    server_Console_rpc_setFormationState,
    server_Console_rpc_setMissionState,
    0 /* no finalization */
    );
