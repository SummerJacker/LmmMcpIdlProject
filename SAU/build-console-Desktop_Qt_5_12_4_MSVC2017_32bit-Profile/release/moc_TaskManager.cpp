...
QT_MOC_LITERAL(1, 12, 16), // "taskStateChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 6), // "taskId"
QT_MOC_LITERAL(4, 37, 8), // "newState"
QT_MOC_LITERAL(5, 46, 19) // "cleanupExpiredTasks"

    },
    "TaskManager\0taskStateChanged\0\0taskId\0"
    "newState\0cleanupExpiredTasks"
};
...
void TaskManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->taskStateChanged((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 1: _t->cleanupExpiredTasks(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskManager::taskStateChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TaskManager::taskStateChanged(const QString & _t1, const QString & _t2)
{
