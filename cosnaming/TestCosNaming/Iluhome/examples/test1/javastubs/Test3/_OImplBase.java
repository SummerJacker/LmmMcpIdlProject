// javastubs/Test3/_OImplBase.java
// Stubs for "Test3"
//
 ...
 */
public abstract class _OImplBase extends org.omg.CORBA.portable.ObjectImpl implements O {

    protected xerox.ilu.IluClassRep _implements() {
        return OStub.iluClass();
    } //_implements
    ...
    protected _OImplBase (java.lang.String name) {
    } //constructor
