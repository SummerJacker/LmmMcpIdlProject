// javastubs/Test2/T1U2Helper.java
// Stubs for "Test2"
//
 ...
 * An ILU helper class.
 */
public class T1U2Helper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new T1U2Helper(), org.omg.CORBA.TCKind.tk_alias);
        xerox.ilu.IluTypeRep __t = null;
        __t = xerox.ilu.IluTypeRep.registerAliasType(
            "T1U2", //name
            "Test2", //islIfName
            null, //islIfBrand
            "ilut:ivO--2zVG+1M+RHVb2fSMGm5pW9", //uid
            "ilut:ivO--2zVG+1M+RHVb2fSMGm5pW9"); //baseUID
        __t = null;
    }
    ...
    public static void insert(org.omg.CORBA.Any _any, Test1.U2 _x) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        _ia.assign(_tc, _x);
    } //insert 

    public static Test1.U2 extract(org.omg.CORBA.Any _any) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
    ...
    public static xerox.ilu.IluPickle to_pickle(Test1.U2 _x) throws org.omg.CORBA.SystemException {
        int _sz = 0;
        xerox.ilu.IluCall _call = null;
        xerox.ilu.IluPickle _pickle = new xerox.ilu.IluPickle();
        try {
            _call = _pickle.startToPickle();
            _sz = Test1.U2Helper._szFunc(_call, _x);
            _pickle.midToPickle(_call, _sz, id());
            Test1.U2Helper._outFunc(_call, _x);
        } finally {
    ...
    public static Test1.U2 from_pickle(xerox.ilu.IluPickle _pickle) throws org.omg.CORBA.SystemException {
        Test1.U2 _x = null;
        xerox.ilu.IluCall _call = null;
        try {
            _call = _pickle.startFromPickle(id());
            _x = Test1.U2Helper._inFunc(_call);
        } finally {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        Test1.U2 _xx = ((Test1.U2)_x);
        return Test1.U2Helper._szFunc(_call, _xx);
    } //szFunc 
