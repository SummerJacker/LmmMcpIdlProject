 ...
 * An ILU helper class.
 */
public class FHelper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new FHelper(), org.omg.CORBA.TCKind.tk_alias);
        ...
        __t = xerox.ilu.IluTypeRep.registerAliasType(
            ...
            "ilut:krAAJGDr0mWg96aGb8cRAqq6LEh"); //baseUID
        __t = null;
    }
    ...
    public static void insert(org.omg.CORBA.Any _any, Test1.TheE _x) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        _ia.assign(_tc, _x);
    } //insert 

    public static Test1.TheE extract(org.omg.CORBA.Any _any) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        java.lang.Object _ob = _ia.cachedValue();
        if (_ob == null) {_ob = _ia.value(_tc);}
        return ((Test1.TheE)_ob);
    } //extract 

    public static xerox.ilu.IluPickle to_pickle(Test1.TheE _x) throws org.omg.CORBA.SystemException {
        int _sz = 0;
    ...
    public static Test1.TheE from_pickle(xerox.ilu.IluPickle _pickle) throws org.omg.CORBA.SystemException {
        Test1.TheE _x = null;
        xerox.ilu.IluCall _call = null;
        try {
            _call = _pickle.startFromPickle(id());
            _x = Test1.TheE.from_int(_call.inEnum());
        } finally {
