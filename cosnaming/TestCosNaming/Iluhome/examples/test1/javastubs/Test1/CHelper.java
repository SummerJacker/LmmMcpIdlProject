 ...
 * An ILU helper class.
 */
public class CHelper implements xerox.ilu.IluIOFunctions  {
    private final static java.lang.String _id = 
        "ilut:gdcPNJEAtHcOYaSV7ue4O0N8kXx";
    private static xerox.ilu.IluTypeCode _tc = null;
    static {
        xerox.ilu.IluPreLoad.checkStubConsistency13("v2 (2.0beta1)");
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new CHelper(), org.omg.CORBA.TCKind.tk_alias);
        xerox.ilu.IluTypeRep __t = null;
        __t = xerox.ilu.IluTypeRep.registerAliasType(
            "C", //name
            "Test1", //islIfName
            null, //islIfBrand
            "ilut:gdcPNJEAtHcOYaSV7ue4O0N8kXx", //uid
            "ilut:gdcPNJEAtHcOYaSV7ue4O0N8kXx"); //baseUID
        __t = null;
    }
    ...
    public java.lang.Object inFunc(xerox.ilu.IluCall _call, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        return new java.lang.Character(_call.inChar16());
    } //inFunc 
