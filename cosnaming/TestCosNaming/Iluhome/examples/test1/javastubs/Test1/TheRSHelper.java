// javastubs/Test1/TheRSHelper.java
// Stubs for "Test1"
//
 ...
 * An ILU helper class.
 */
public class TheRSHelper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        RHelper.id();
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new TheRSHelper(), org.omg.CORBA.TCKind.tk_sequence);
    }
