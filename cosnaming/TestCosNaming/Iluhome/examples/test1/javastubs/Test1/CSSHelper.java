// javastubs/Test1/CSSHelper.java
// Stubs for "Test1"
//
 ...
 * An ILU helper class.
 */
public class CSSHelper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        ScSHelper.id();
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new CSSHelper(), org.omg.CORBA.TCKind.tk_sequence);
    }
    ...
    public static xerox.ilu.IluPickle to_pickle(java.lang.String[] _x) throws org.omg.CORBA.SystemException {
        ...
        try {
            ...
            _sz = CSS._szFunc(_call, _x);
            _pickle.midToPickle(_call, _sz, id());
            CSS._outFunc(_call, _x);
        } finally {
