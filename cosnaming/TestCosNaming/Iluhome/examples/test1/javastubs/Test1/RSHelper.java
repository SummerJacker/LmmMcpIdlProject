 ...
 * An ILU helper class.
 */
public class RSHelper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new RSHelper(), org.omg.CORBA.TCKind.tk_alias);
        xerox.ilu.IluTypeRep __t = null;
        __t = xerox.ilu.IluTypeRep.registerAliasType(
            "RS", //name
            "Test1", //islIfName
            null, //islIfBrand
            "ilut:dHs+dKhOHPjZlhqF+GcshQD3Zac", //uid
            "ilut:dHs+dKhOHPjZlhqF+GcshQD3Zac"); //baseUID
        __t = null;
    }
    ...
    public static xerox.ilu.IluPickle to_pickle(TheR[] _x) throws org.omg.CORBA.SystemException {
        ...
        try {
            ...
            _sz = TheRS._szFunc(_call, _x);
            _pickle.midToPickle(_call, _sz, id());
            TheRS._outFunc(_call, _x);
        } finally {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        TheR[] _xx = ((TheR[])_x);
        return TheRS._szFunc(_call, _xx);
    } //szFunc 
