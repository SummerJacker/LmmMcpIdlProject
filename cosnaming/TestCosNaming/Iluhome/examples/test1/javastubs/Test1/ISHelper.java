 ...
 * An ILU helper class.
 */
public class ISHelper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new ISHelper(), org.omg.CORBA.TCKind.tk_sequence);
    }
    ...
    public static xerox.ilu.IluPickle to_pickle(int[] _x) throws org.omg.CORBA.SystemException {
        ...
        try {
            ...
            _sz = IS._szFunc(_call, _x);
            _pickle.midToPickle(_call, _sz, id());
            IS._outFunc(_call, _x);
        } finally {
