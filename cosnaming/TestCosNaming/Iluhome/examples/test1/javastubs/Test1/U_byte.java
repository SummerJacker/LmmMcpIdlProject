 ...
 */
public class U_byte implements java.io.Serializable {
    boolean _init = false;
    byte _dis = 0;
    ...
    public static U_byte alloc_R(byte _dis, TheR _v)
            throws org.omg.CORBA.BAD_OPERATION {
        U_byte _res = new U_byte();
        _res.set_R(_dis, _v);
        return _res;
    } //alloc_R

    public static U_byte alloc_R(TheR _v)
            throws org.omg.CORBA.BAD_OPERATION {
        return alloc_R((byte)0, _v);
    } //alloc_R
    ...
    public void set_R(byte _d, TheR _v)
            throws org.omg.CORBA.BAD_OPERATION {
        switch (_d) {
            case (byte)0:
                break;
    ...
    public static U_byte alloc_O2(byte _dis, O2 _v)
            throws org.omg.CORBA.BAD_OPERATION {
        U_byte _res = new U_byte();
        _res.set_O2(_dis, _v);
        return _res;
    ...
    public static U_byte alloc_O2(O2 _v)
            throws org.omg.CORBA.BAD_OPERATION {
        return alloc_O2((byte)1, _v);
    } //alloc_O2
    ...
    public void set_O2(byte _d, O2 _v)
            throws org.omg.CORBA.BAD_OPERATION {
        switch (_d) {
            case (byte)1:
                break;
