/* $Id: ngwebserver.c,v 1.5 2025/08/01 05:29:37 cvswxc Exp $ */
...
ILU_PUBLIC ilu_boolean ilu_http_force_close_on_ilu_1_1;
...
nextarg:
	...
	/* force 1.1 connection closure for non iluhttp.resource objects accessed
	   with http_1_0 */
	if (strcmp(g_pc_http_pinfo, "http_1_1") == 0)
	  ilu_http_force_close_on_ilu_1_1 = ilu_FALSE;
