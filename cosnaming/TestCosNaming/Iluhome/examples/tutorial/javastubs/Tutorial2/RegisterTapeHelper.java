// javastubs/Tutorial2/RegisterTapeHelper.java
// Stubs for "Tutorial2"
//
 ...
 * An ILU helper class.
 */
public class RegisterTapeHelper implements xerox.ilu.IluIOFunctions  {
    private final static java.lang.String _id = 
        "ilut:i03-tJkWBPLHe2ONK6OHat-LDSV";
    private static xerox.ilu.IluTypeCode _tc = null;
    static {
        xerox.ilu.IluPreLoad.checkStubConsistency13("v2 (2.0beta1)");
        OperationHelper.id();
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new RegisterTapeHelper(), org.omg.CORBA.TCKind.tk_sequence);
    }
    ...
    public static xerox.ilu.IluPickle to_pickle(Operation[] _x) throws org.omg.CORBA.SystemException {
        ...
        try {
            ...
            _sz = RegisterTape._szFunc(_call, _x);
            _pickle.midToPickle(_call, _sz, id());
            RegisterTape._outFunc(_call, _x);
        } finally {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        ...
        return RegisterTape._szFunc(_call, _xx);
    } //szFunc 
