// javastubs/Tutorial2/FactoryHelper.java
// Stubs for "Tutorial2"
//
 ...
 * An ILU helper class.
 */
public class FactoryHelper implements xerox.ilu.IluIOFunctions  {
    private final static java.lang.String _id = 
        "ilut:cPIlfNX5Jw85kJwez4xg3JIM5ky";
    private static xerox.ilu.IluTypeCode _tc = null;
    static {
        xerox.ilu.IluPreLoad.checkStubConsistency13("v2 (2.0beta1)");
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new FactoryHelper(), org.omg.CORBA.TCKind.tk_objref);
    }
    ...
    public static void insert(org.omg.CORBA.Any _any, Factory _x) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        _ia.assign(_tc, _x);
    } //insert 

    public static Factory extract(org.omg.CORBA.Any _any) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
    ...
    public static xerox.ilu.IluPickle to_pickle(Factory _x) throws org.omg.CORBA.SystemException {
        int _sz = 0;
        xerox.ilu.IluCall _call = null;
        xerox.ilu.IluPickle _pickle = new xerox.ilu.IluPickle();
        try {
            _call = _pickle.startToPickle();
            _sz = _call.szObject(_x, false, FactoryStub.iluClass());
            _pickle.midToPickle(_call, _sz, id());
            _call.outObject(_x, false, FactoryStub.iluClass());
        } finally {
    ...
    public static Factory from_pickle(xerox.ilu.IluPickle _pickle) throws org.omg.CORBA.SystemException {
        Factory _x = null;
        xerox.ilu.IluCall _call = null;
        try {
            _call = _pickle.startFromPickle(id());
            _x = (Factory) _call.inObject(false, FactoryStub.iluClass());
        } finally {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        Factory _xx = ((Factory)_x);
        return _call.szObject(_xx, false, FactoryStub.iluClass());
    } //szFunc 
