 ...
 * An ILU helper class.
 */
public class O3Helper implements xerox.ilu.IluIOFunctions  {
    private final static java.lang.String _id = 
        "ilut:lQr6i5J1cc5ITlb7sSnXWCReRuU";
    private static xerox.ilu.IluTypeCode _tc = null;
    static {
        xerox.ilu.IluPreLoad.checkStubConsistency13("v2 (2.0beta1)");
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new O3Helper(), org.omg.CORBA.TCKind.tk_objref);
    }
    ...
    public static void insert(org.omg.CORBA.Any _any, O3 _x) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        _ia.assign(_tc, _x);
    } //insert 

    public static O3 extract(org.omg.CORBA.Any _any) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
    ...
    public static xerox.ilu.IluPickle to_pickle(O3 _x) throws org.omg.CORBA.SystemException {
        int _sz = 0;
        xerox.ilu.IluCall _call = null;
        xerox.ilu.IluPickle _pickle = new xerox.ilu.IluPickle();
        try {
            _call = _pickle.startToPickle();
            _sz = _call.szObject(_x, false, O3Stub.iluClass());
            _pickle.midToPickle(_call, _sz, id());
            _call.outObject(_x, false, O3Stub.iluClass());
        } finally {
    ...
    public static O3 from_pickle(xerox.ilu.IluPickle _pickle) throws org.omg.CORBA.SystemException {
        O3 _x = null;
        xerox.ilu.IluCall _call = null;
        try {
            _call = _pickle.startFromPickle(id());
            _x = (O3) _call.inObject(false, O3Stub.iluClass());
        } finally {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        O3 _xx = ((O3)_x);
        return _call.szObject(_xx, false, O3Stub.iluClass());
    } //szFunc 
