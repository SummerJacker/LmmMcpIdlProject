 ...
 */
public class U_int implements java.io.Serializable {
    boolean _init = false;
    int _dis = 0;
    ...
    public static U_int alloc_R(int _dis, TheR _v)
            throws org.omg.CORBA.BAD_OPERATION {
        U_int _res = new U_int();
        _res.set_R(_dis, _v);
        return _res;
    } //alloc_R

    public static U_int alloc_R(TheR _v)
            throws org.omg.CORBA.BAD_OPERATION {
        return alloc_R(0, _v);
    } //alloc_R
    ...
    public static U_int alloc_O5(int _dis, O5 _v)
            throws org.omg.CORBA.BAD_OPERATION {
        U_int _res = new U_int();
        _res.set_O5(_dis, _v);
        return _res;
    ...
    public static U_int alloc_O5(O5 _v)
            throws org.omg.CORBA.BAD_OPERATION {
