 ...
 * An ILU helper class.
 */
public class A0Helper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new A0Helper(), org.omg.CORBA.TCKind.tk_array);
    }
    ...
    public static xerox.ilu.IluPickle to_pickle(byte[] _x) throws org.omg.CORBA.SystemException {
        ...
        try {
            ...
            _sz = _call.szBytesA(_x, 8);
            _pickle.midToPickle(_call, _sz, id());
            _call.outBytesA(_x, 8);
        } finally {
