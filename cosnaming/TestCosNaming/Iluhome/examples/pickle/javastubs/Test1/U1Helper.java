 ...
 * An ILU helper class.
 */
public class U1Helper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        RHelper.id();
        A1Helper.id();
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new U1Helper(), org.omg.CORBA.TCKind.tk_union);
    }
    ...
    public static void insert(org.omg.CORBA.Any _any, U1 _x) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        _ia.assign(_tc, _x);
    } //insert 

    public static U1 extract(org.omg.CORBA.Any _any) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
    ...
    public static xerox.ilu.IluPickle to_pickle(U1 _x) throws org.omg.CORBA.SystemException {
        int _sz = 0;
        xerox.ilu.IluCall _call = null;
        xerox.ilu.IluPickle _pickle = new xerox.ilu.IluPickle();
        try {
            _call = _pickle.startToPickle();
            _sz = U1Helper._szFunc(_call, _x);
            _pickle.midToPickle(_call, _sz, id());
            U1Helper._outFunc(_call, _x);
        } finally {
    ...
    public static U1 from_pickle(xerox.ilu.IluPickle _pickle) throws org.omg.CORBA.SystemException {
        U1 _x = null;
        xerox.ilu.IluCall _call = null;
        try {
            _call = _pickle.startFromPickle(id());
            _x = U1Helper._inFunc(_call);
        } finally {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        U1 _xx = ((U1)_x);
        return U1Helper._szFunc(_call, _xx);
    } //szFunc 
        ...
        throws org.omg.CORBA.SystemException
    {
        ...
        switch(_a._dis) {
            case (short)0:
                ...
                break;
            case (short)1:
                _sz = _sz + TheA1.szFunc(_call, ((java.lang.String[])_a._val));
                break;
        }
        _call.endUnion();
        return _sz;
    ...
    public static void _outFunc(xerox.ilu.IluCall _call, U1 _a) 
        throws org.omg.CORBA.SystemException
    {
        ...
        switch(_a._dis) {
            case (short)0:
                ...
                break;
            case (short)1:
                TheA1.outFunc(_call, ((java.lang.String[])_a._val));
                break;
        }
        _call.endUnion();
    } //_outFunc

    public static U1 _inFunc(xerox.ilu.IluCall _call) 
        throws org.omg.CORBA.SystemException
    {
        U1 _v = null;
        short _d;
        ...
        switch(_d) {
            case (short)0:
                _v = U1.alloc_R(_d, TheRHelper._inFunc(_call));
                break;
            case (short)1:
                _v = U1.alloc_A1(_d, TheA1.inFunc(_call));
                break;
            default:
              _call.endUnion();
    ...
    static {
        ...
        __t.registerUnionArm(
            1, //armNum
            null, //islArmName
            "ilut:h3Dnvis94UwnmFURfYsCp700jVy", //armUID
            1, //valNum
            _ivals, //ivals
            _svals); //svals
        __t.finish();
