 ...
 * An ILU helper class.
 */
public class OOHelper implements xerox.ilu.IluIOFunctions  {
    private final static java.lang.String _id = 
        "ilut:kpovP3jt0mWKroAd3v+z9qwsgeL";
    private static xerox.ilu.IluTypeCode _tc = null;
    static {
        xerox.ilu.IluPreLoad.checkStubConsistency13("v2 (2.0beta1)");
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new OOHelper(), org.omg.CORBA.TCKind.tk_alias);
        ...
        __t = xerox.ilu.IluTypeRep.registerAliasType(
            ...
            "ilut:kpovP3jt0mWKroAd3v+z9qwsgeL"); //baseUID
        __t = null;
    }
    ...
    public static xerox.ilu.IluPickle to_pickle(O5 _x) throws org.omg.CORBA.SystemException {
        ...
        try {
            ...
            _sz = TheOOStub._szFunc(_call, _x);
            _pickle.midToPickle(_call, _sz, id());
            TheOOStub._outFunc(_call, _x);
        } finally {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        O5 _xx = ((O5)_x);
        return TheOOStub._szFunc(_call, _xx);
    } //szFunc 
