 ...
 * An ILU helper class.
 */
public class BSHelper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new BSHelper(), org.omg.CORBA.TCKind.tk_sequence);
    }
    ...
    public static void insert(org.omg.CORBA.Any _any, byte[] _x) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        _ia.assign(_tc, _x);
    } //insert 

    public static byte[] extract(org.omg.CORBA.Any _any) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
    ...
    public static byte[] from_pickle(xerox.ilu.IluPickle _pickle) throws org.omg.CORBA.SystemException {
        byte[] _x = null;
        xerox.ilu.IluCall _call = null;
        try {
