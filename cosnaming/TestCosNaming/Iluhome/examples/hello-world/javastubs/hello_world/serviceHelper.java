// javastubs/hello_world/serviceHelper.java
 ...
 * An ILU helper class.
 */
public class serviceHelper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new serviceHelper(), org.omg.CORBA.TCKind.tk_objref);
    }
    ...
    public static void insert(org.omg.CORBA.Any _any, service _x) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        _ia.assign(_tc, _x);
    } //insert 

    public static service extract(org.omg.CORBA.Any _any) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
    ...
    public static xerox.ilu.IluPickle to_pickle(service _x) throws org.omg.CORBA.SystemException {
        int _sz = 0;
        xerox.ilu.IluCall _call = null;
        xerox.ilu.IluPickle _pickle = new xerox.ilu.IluPickle();
        try {
            _call = _pickle.startToPickle();
            _sz = _call.szObject(_x, false, serviceStub.iluClass());
            _pickle.midToPickle(_call, _sz, id());
            _call.outObject(_x, false, serviceStub.iluClass());
        } finally {
    ...
    public static service from_pickle(xerox.ilu.IluPickle _pickle) throws org.omg.CORBA.SystemException {
        service _x = null;
        xerox.ilu.IluCall _call = null;
        try {
            _call = _pickle.startFromPickle(id());
            _x = (service) _call.inObject(false, serviceStub.iluClass());
        } finally {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        service _xx = ((service)_x);
        return _call.szObject(_xx, false, serviceStub.iluClass());
    } //szFunc 
