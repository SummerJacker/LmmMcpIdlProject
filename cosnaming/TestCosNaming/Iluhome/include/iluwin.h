...
/*$Id: iluwin.h,v 2.3 2025/07/29 06:38:03 cvswxc Exp $*/
...
/* The number of bytes in an enum.  C++11 after may define enum's lenght */
...
/* different Linux where WCHAR is 4, in windows whatever it's 32 or 64, WCHAR's length is always 2 */
...
/* Define this if you're building the WIN32 or WIN64 thread support */
#if defined(WIN32) || defined(WIN64) 
...
#define ILU_BINDING_DIRECTORY "\\iluwin" 
#endif
...
#define ILU_DEFAULT_PROTOCOL_INFO "iiop"
...
#define ILU_DEFAULT_TRANSPORT_INFO  "tcp_0_0"
...
#define ILU_WIN32_CONNECT_WRITE_TIMEOUT 10
...
#define ILU_TYPEUID_VERSION_STRING "v2 (2.0beta1)"
#else
...
/*
 $Log: iluwin.h,v $
 Revision 2.3  2025/07/29 06:38:03  cvswxc
 #681 remove the big ILU formating infor
 Committed on the Free edition of March Hare Software CVSNT Server.
 Upgrade to CVS Suite for more features and support:
 http://march-hare.com/cvsnt/

 Revision 2.2  2022/04/03 03:03:10  cvswxc
 修订32位Win操作系统下timeout时间从30变为10   #666

 Revision 2.1  2020/06/12 08:33:11  cvswky
 #663 64位操作系统改进

 Revision 2.0  2014/04/15 08:53:21  cvsczh
 no message
