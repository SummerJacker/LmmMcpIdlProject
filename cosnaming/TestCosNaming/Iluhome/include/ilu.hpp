/* $Id: ilu.hpp,v 2.4 2025/07/29 06:35:11 cvswxc Exp $ 
 Updates 修改记录
 Revision 2.4  2025/07/29 06:35:11  cvswxc
 #681 remove the big ILU formating infor

 Revision 2.3  2020/06/15 02:59:54  cvswxc
 #658 typos fix and more WIN32 handling

 Revision 2.2  2020/06/12 04:19:02  cvswky
 #658 linux与windows统一使用sstream头文件

 Revision 2.1  2019/12/06 07:57:53  cvswxc
 字符转换处理用sstream替代strstream #660
...
#else
ILU_RUNTIME_PUBLIC char* iluCppTagFormatString (char* pc_destination, const char* pc_source); //Shaun ADD //

#define ILUCPP_DEBUG1(formatstring)
#define ILUCPP_DEBUG2(formatstring, arg1)
#define ILUCPP_DEBUG3(formatstring, arg1, arg2)
#define ILUCPP_DEBUG4(formatstring, arg1, arg2, arg3)
#define ILUCPP_DEBUG5(formatstring, arg1, arg2, arg3, arg4) //Shaun MDF all above //
...
public :
	...
	static iluClass	iluDefineObjectType(
		...
		iluCString* ppc_array_of_superclass_ids
             ...
             ,
		     iluCardinal cl_nstate_fields,
		     ILUCPP_BOOL cl_local,
		     ILUCPP_BOOL cl_sealed
#endif
			 );
