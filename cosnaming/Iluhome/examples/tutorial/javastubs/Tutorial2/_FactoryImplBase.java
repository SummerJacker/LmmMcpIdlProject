// javastubs/Tutorial2/_FactoryImplBase.java
// Stubs for "Tutorial2"
//
 ...
 */
public abstract class _FactoryImplBase extends org.omg.CORBA.portable.ObjectImpl implements Factory {

    protected xerox.ilu.IluClassRep _implements() {
        return FactoryStub.iluClass();
    } //_implements

    public Factory _this() {
        return this;
    } //_this

    public _FactoryImplBase () {
    } //constructor

    protected _FactoryImplBase (java.lang.String name) {
    } //constructor
