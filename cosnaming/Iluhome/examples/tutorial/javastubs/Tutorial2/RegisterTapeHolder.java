// javastubs/Tutorial2/RegisterTapeHolder.java
// Stubs for "Tutorial2"
//
...
/** holder class for RegisterTape */
public final class RegisterTapeHolder {
    public Operation[] value = null;

    public RegisterTapeHolder() {
    }

    public RegisterTapeHolder(Operation[] _arg) {
        this.value = _arg;
    }
