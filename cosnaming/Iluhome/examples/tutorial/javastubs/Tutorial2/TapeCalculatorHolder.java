// javastubs/Tutorial2/TapeCalculatorHolder.java
// Stubs for "Tutorial2"
//
...
/** holder class for TapeCalculator */
public final class TapeCalculatorHolder {
    public TapeCalculator value = null;

    public TapeCalculatorHolder() {
    }

    public TapeCalculatorHolder(TapeCalculator _arg) {
        this.value = _arg;
    }

}//TapeCalculatorHolder
