// javastubs/Tutorial/CalculatorHelper.java
// Stubs for "Tutorial"
//
 ...
 * An ILU helper class.
 */
public class CalculatorHelper implements xerox.ilu.IluIOFunctions  {
    private final static java.lang.String _id = 
        "ilut:hKWsBzveel2pjsqsi1Gw1UPmSNS";
    private static xerox.ilu.IluTypeCode _tc = null;
    static {
        xerox.ilu.IluPreLoad.checkStubConsistency13("v2 (2.0beta1)");
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new CalculatorHelper(), org.omg.CORBA.TCKind.tk_objref);
    }
    ...
    public static void insert(org.omg.CORBA.Any _any, Calculator _x) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        _ia.assign(_tc, _x);
    } //insert 

    public static Calculator extract(org.omg.CORBA.Any _any) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        java.lang.Object _ob = _ia.cachedValue();
        if (_ob == null) {_ob = _ia.value(_tc);}
        return ((Calculator)_ob);
    } //extract 

    public static xerox.ilu.IluPickle to_pickle(Calculator _x) throws org.omg.CORBA.SystemException {
        int _sz = 0;
        xerox.ilu.IluCall _call = null;
        xerox.ilu.IluPickle _pickle = new xerox.ilu.IluPickle();
        try {
            _call = _pickle.startToPickle();
            _sz = _call.szObject(_x, false, CalculatorStub.iluClass());
            _pickle.midToPickle(_call, _sz, id());
            _call.outObject(_x, false, CalculatorStub.iluClass());
        } finally {
    ...
    public static Calculator from_pickle(xerox.ilu.IluPickle _pickle) throws org.omg.CORBA.SystemException {
        Calculator _x = null;
        xerox.ilu.IluCall _call = null;
        try {
            _call = _pickle.startFromPickle(id());
            _x = (Calculator) _call.inObject(false, CalculatorStub.iluClass());
        } finally {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        Calculator _xx = ((Calculator)_x);
        return _call.szObject(_xx, false, CalculatorStub.iluClass());
    } //szFunc 
