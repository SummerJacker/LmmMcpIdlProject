...
/** 
 * Class representing an ILU user exception.
 */
public class E1 extends xerox.ilu.IluUserException {

    public Test1.TheU value = null;

    public E1(Test1.TheU _val) {
        super();
        this.value = _val;
    }
