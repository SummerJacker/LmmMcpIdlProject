// javastubs/Test3/T2T1O3Helper.java
// Stubs for "Test3"
//
 ...
 * An ILU helper class.
 */
public class T2T1O3Helper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new T2T1O3Helper(), org.omg.CORBA.TCKind.tk_alias);
        ...
        __t = xerox.ilu.IluTypeRep.registerAliasType(
            ...
            "ilut:kIcGG8a2ke5Wa9+mDM-6ArsNDpU"); //baseUID
        __t = null;
    }
    ...
    public static void insert(org.omg.CORBA.Any _any, Test1.O3 _x) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        _ia.assign(_tc, _x);
    } //insert 

    public static Test1.O3 extract(org.omg.CORBA.Any _any) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
    ...
    public static xerox.ilu.IluPickle to_pickle(Test1.O3 _x) throws org.omg.CORBA.SystemException {
        int _sz = 0;
        xerox.ilu.IluCall _call = null;
        xerox.ilu.IluPickle _pickle = new xerox.ilu.IluPickle();
        try {
            _call = _pickle.startToPickle();
            _sz = _call.szObject(_x, false, Test1.O3Stub.iluClass());
            _pickle.midToPickle(_call, _sz, id());
            _call.outObject(_x, false, Test1.O3Stub.iluClass());
        } finally {
    ...
    public static Test1.O3 from_pickle(xerox.ilu.IluPickle _pickle) throws org.omg.CORBA.SystemException {
        Test1.O3 _x = null;
        xerox.ilu.IluCall _call = null;
        try {
            _call = _pickle.startFromPickle(id());
            _x = (Test1.O3) _call.inObject(false, Test1.O3Stub.iluClass());
        } finally {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        Test1.O3 _xx = ((Test1.O3)_x);
        return _call.szObject(_xx, false, Test1.O3Stub.iluClass());
    } //szFunc 
