 ...
 * An ILU helper class.
 */
public class SCHelper implements xerox.ilu.IluIOFunctions  {
    private final static java.lang.String _id = 
        "ilut:pdAUFqZte+fyI-N5f1DgbGKd0K0";
    private static xerox.ilu.IluTypeCode _tc = null;
    static {
        xerox.ilu.IluPreLoad.checkStubConsistency13("v2 (2.0beta1)");
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new SCHelper(), org.omg.CORBA.TCKind.tk_alias);
        xerox.ilu.IluTypeRep __t = null;
        __t = xerox.ilu.IluTypeRep.registerAliasType(
            "SC", //name
            "Test1", //islIfName
            null, //islIfBrand
            "ilut:pdAUFqZte+fyI-N5f1DgbGKd0K0", //uid
            "ilut:pdAUFqZte+fyI-N5f1DgbGKd0K0"); //baseUID
        __t = null;
    }
    ...
    public static void insert(org.omg.CORBA.Any _any, char _x) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        _ia.assign(_tc, new java.lang.Character(_x));
    } //insert 

    public static char extract(org.omg.CORBA.Any _any) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        java.lang.Object _ob = _ia.cachedValue();
        if (_ob == null) {_ob = _ia.value(_tc);}
        return ((java.lang.Character)_ob).charValue();
    } //extract 

    public static xerox.ilu.IluPickle to_pickle(char _x) throws org.omg.CORBA.SystemException {
        int _sz = 0;
        xerox.ilu.IluCall _call = null;
        xerox.ilu.IluPickle _pickle = new xerox.ilu.IluPickle();
        try {
            _call = _pickle.startToPickle();
            _sz = _call.szChar8(_x);
    ...
    public static char from_pickle(xerox.ilu.IluPickle _pickle) throws org.omg.CORBA.SystemException {
        char _x = '\u0000';
        xerox.ilu.IluCall _call = null;
        try {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        char _xx = ((java.lang.Character)_x).charValue();
        return _call.szChar8(_xx);
    } //szFunc 
    ...
    public java.lang.Object inFunc(xerox.ilu.IluCall _call, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        return new java.lang.Character(_call.inChar8());
    } //inFunc 
