 ...
 * An ILU helper class.
 */
public class A1Helper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new A1Helper(), org.omg.CORBA.TCKind.tk_alias);
        ...
        __t = xerox.ilu.IluTypeRep.registerAliasType(
            ...
            "ilut:h3Dnvis94UwnmFURfYsCp700jVy"); //baseUID
        __t = null;
    }
    ...
    public static xerox.ilu.IluPickle to_pickle(java.lang.String[] _x) throws org.omg.CORBA.SystemException {
        ...
        try {
            ...
            _sz = TheA1.szFunc(_call, _x);
            _pickle.midToPickle(_call, _sz, id());
            TheA1.outFunc(_call, _x);
        } finally {
