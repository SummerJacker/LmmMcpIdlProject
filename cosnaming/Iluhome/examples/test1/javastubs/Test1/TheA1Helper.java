// javastubs/Test1/TheA1Helper.java
// Stubs for "Test1"
//
 ...
 * An ILU helper class.
 */
public class TheA1Helper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        ScSHelper.id();
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new TheA1Helper(), org.omg.CORBA.TCKind.tk_array);
    }
