 ...
 * An ILU helper class.
 */
public class EHelper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new EHelper(), org.omg.CORBA.TCKind.tk_alias);
