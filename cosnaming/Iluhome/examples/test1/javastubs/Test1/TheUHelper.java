...
public class TheUHelper implements xerox.ilu.IluIOFunctions  {
        ...
        throws org.omg.CORBA.SystemException
    {
        ...
        switch(_a._dis) {
            ...
            case (short)2:
                ...
                break;
            case (short)3:
                _sz = _sz + _call.szObject(((TheO1)_a._val), false, TheO1Stub.iluClass());
                break;
            case (short)4:
                _sz = _sz + TheOOStub._szFunc(_call, ((TheO1)_a._val));
                break;
            case (short)5:
        ...
        throws org.omg.CORBA.SystemException
    {
        ...
        switch(_a._dis) {
            ...
            case (short)2:
                ...
                break;
            case (short)3:
                _call.outObject(((TheO1)_a._val), false, TheO1Stub.iluClass());
                break;
            case (short)4:
                TheOOStub._outFunc(_call, ((TheO1)_a._val));
                break;
            case (short)5:
        ...
        throws org.omg.CORBA.SystemException
    {
        ...
        switch(_d) {
            ...
            case (short)2:
                ...
                break;
            case (short)3:
                _v = TheU.alloc_O1(_d, (TheO1) _call.inObject(false, TheO1Stub.iluClass()));
                break;
            case (short)4:
    ...
    static {
        ...
        __t.registerUnionArm(
            4, //armNum
            null, //islArmName
            "ilut:i9j-e0MTap9-HvwoTuOR4HVGRXA", //armUID
            1, //valNum
            _ivals, //ivals
            _svals); //svals
        _ivals = new int[1];
