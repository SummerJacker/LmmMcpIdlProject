...
public class E2_exh_ extends E2 {

    public E2_exh_() {
        super();
    }

    public E2_exh_(int _val) {
        super();
        //not used; but required by type system
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }

    private static xerox.ilu.IluExceptionRep _E2_rep;
    public static final xerox.ilu.IluExceptionRep _E2getRep() {
        return _E2_rep;
    }
    ...
    public void readException(java.lang.Object call)
        ...
        this.value = _call.inInt32();
    } //readException

    //NOT really public; Must be accessible by ilu...
    public static void _E2_marshall(E2 _ex, int index, xerox.ilu.IluCall _call)
            throws org.omg.CORBA.SystemException {
        int sz = 0;
        if (_call.needsSizing()) {
            sz = _call.beginSizingException(index);
            sz += _call.szInt32(_ex.value);
        }
        _call.startWriteException(index, sz);
        _call.outInt32(_ex.value);
        _call.doneWriteException();
    } //_E2_marshall

    static {
        _E2_rep = xerox.ilu.IluExceptionRep.defineException(
            "Test1.E2_exh_", //java class name
            "Test1", //isl interface name
            "E2", //isl exception name
            "ilut:ggrbg-q7UoqiAlNTWvqkwfZ4rlY"); //type uuid
    }
