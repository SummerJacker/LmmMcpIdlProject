...
public class U2 implements java.io.Serializable {
    ...
    public static U2 alloc_x1(short _dis, boolean _v)
            throws org.omg.CORBA.BAD_OPERATION {
        U2 _res = new U2();
        _res.set_x1(_dis, _v);
        return _res;
    ...
    public static U2 alloc_x1(boolean _v)
            throws org.omg.CORBA.BAD_OPERATION {
    ...
    public static U2 alloc_x2(short _dis, O2 _v)
            throws org.omg.CORBA.BAD_OPERATION {
        U2 _res = new U2();
        _res.set_x2(_dis, _v);
        return _res;
    ...
    public static U2 alloc_x2(O2 _v)
            throws org.omg.CORBA.BAD_OPERATION {
        return alloc_x2((short)1, _v);
    } //alloc_x2
    ...
    public void set_x2(short _d, O2 _v)
            throws org.omg.CORBA.BAD_OPERATION {
        switch (_d) {
            case (short)1:
            case (short)22:
    ...
    public void set_x2(O2 _v) {
        set_x2((short)1, _v);
    } //set_x2

    public static U2 alloc_x3(short _dis, java.lang.String[] _v)
            throws org.omg.CORBA.BAD_OPERATION {
        U2 _res = new U2();
        _res.set_x3(_dis, _v);
        return _res;
    ...
    public static U2 alloc_x3(java.lang.String[] _v)
            throws org.omg.CORBA.BAD_OPERATION {
        return alloc_x3((short)2, _v);
    } //alloc_x3
    ...
    public static U2 allocOther(short _dis)
            throws org.omg.CORBA.BAD_OPERATION {
        U2 _res = new U2();
        _res.setOther(_dis);
        return _res;
