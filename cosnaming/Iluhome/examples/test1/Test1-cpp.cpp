...
/* xxx temp debugging only 
 ...
 // accessors
  ...
  CORBA_Boolean Test1_TheRS::release() const{
    return m_release;
  }
  
  // buffer accessors
  Test1_TheR* Test1_TheRS::get_buffer (CORBA_Boolean orphan){
    if(orphan) {
	  if(!m_release)
	    return NULL;
	  m_release = ilu_FALSE;
  ...
  Test1_TheR const* Test1_TheRS::get_buffer () const{
	return m_buffer;
  }
 ...
 // accessors
  ...
  CORBA_Boolean Test1_BS::release() const{
    return m_release;
  }
  
  // buffer accessors
  CORBA_Octet* Test1_BS::get_buffer (CORBA_Boolean orphan){
    if(orphan) {
	  if(!m_release)
	    return NULL;
	  m_release = ilu_FALSE;
  ...
  CORBA_Octet const* Test1_BS::get_buffer () const{
	return m_buffer;
  }
 ...
 // accessors
  ...
  CORBA_Boolean Test1_CSS::release() const{
    return m_release;
  }
  
  // buffer accessors
  iluShortCharacter** Test1_CSS::get_buffer (CORBA_Boolean orphan){
    if(orphan) {
	  if(!m_release)
	    return NULL;
	  m_release = ilu_FALSE;
  ...
  iluShortCharacter* const* Test1_CSS::get_buffer () const{
	return m_buffer;
  }
 ...
 // accessors
  ...
  CORBA_Boolean Test1_IS::release() const{
    return m_release;
  }
  
  // buffer accessors
  CORBA_Long* Test1_IS::get_buffer (CORBA_Boolean orphan){
    if(orphan) {
	  if(!m_release)
	    return NULL;
	  m_release = ilu_FALSE;
  ...
  CORBA_Long const* Test1_IS::get_buffer () const{
	return m_buffer;
  }
