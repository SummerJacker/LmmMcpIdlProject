   ...
   class Test1_TheRS {
    ...
    public:
       ...
       // constructors & destructor
        ...
        Test1_R* get_buffer (CORBA_Boolean orphan = ilu_FALSE);
        Test1_R const* get_buffer () const;
   ...
   class Test1_BS {
    ...
    public:
       ...
       // constructors & destructor
        ...
        void length (CORBA_ULong len);
		CORBA_Boolean release() const;
        CORBA_Octet* get_buffer (CORBA_Boolean orphan = ilu_FALSE);
        CORBA_Octet const* get_buffer () const;
   ...
   class Test1_CSS {
    ...
    public:
       ...
       // constructors & destructor
        ...
        void length (CORBA_ULong len);
		CORBA_Boolean release() const;
        iluShortCharacter** get_buffer (CORBA_Boolean orphan = ilu_FALSE);
