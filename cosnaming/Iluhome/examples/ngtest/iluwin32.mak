...
.isl.h:
    c-stubber -I $(ILUHOME)\interfaces $*.isl
    
# to make an c file from an isl file
.isl.c:
    c-stubber -I  $(ILUHOME)\interface  $*.isl
