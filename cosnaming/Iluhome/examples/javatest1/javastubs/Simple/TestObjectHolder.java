// javastubs/Simple/TestObjectHolder.java
// Stubs for "Simple"
//
...
/** holder class for TestObject */
public final class TestObjectHolder {
    public TestObject value = null;

    public TestObjectHolder() {
    }

    public TestObjectHolder(TestObject _arg) {
        this.value = _arg;
    }
