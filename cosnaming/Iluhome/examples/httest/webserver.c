/* $Id: webserver.c,v 1.6 2025/08/07 13:51:07 cvswxc Exp $ */
...
#if (defined WIN64 || defined WIN32 || defined WIN16)
#include <winsock.h>
#include <io.h>
#include <direct.h>
...
\tpinfo - one of http_1_1 (default), or http_1_0 (not persistent connections)\n\
...
int main(int ac, char **av) {
	...
	char* pc_protocol_info_default = "http_1_1";		/* denotes use of http (with persistence) as the protocol */
