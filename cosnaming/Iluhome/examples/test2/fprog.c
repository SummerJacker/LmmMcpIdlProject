/* $Id: fprog.c,v 1.6 2025/08/02 10:52:05 cvswxc Exp $ */
       ...
       ILU_C_ENVIRONMENT * Env)
{
  ...
  *ans = Fibber_T_Calc(ask, d, n, self, &lenv);
  ...
  case ILU_C_USER_EXCEPTION:
    if (ILU_C_EXCEPTION_ID(&lenv) == ex_Fibber_Failed) {
      ...
      Fibber_StringSeq_Append(ss,
			      (Fibber_String) ILU_C_Strdup("Unexpected user exception"), NULL);
      Fibber_StringSeq_Append(ss,
			      (Fibber_String) ILU_C_Strdup(ILU_C_EXCEPTION_ID(&lenv)),NULL);
  ...
  case ILU_C_SYSTEM_EXCEPTION:{
      ...
      ss = Fibber_StringSeq_Create(2, NULL);
      Fibber_StringSeq_Append(ss,
			      (Fibber_String) ILU_C_Strdup("system exception"),NULL);
      Fibber_StringSeq_Append(ss, (Fibber_String) ILU_C_Strdup(buf),NULL);
    break;
    }
  default:
    ss = Fibber_StringSeq_Create(1, NULL);
    Fibber_StringSeq_Append(ss,
			    (Fibber_String) ILU_C_Strdup("Unexpected lenv._major"),NULL);
...
static void Solve(void *arg)
{
  ...
  case ILU_C_SYSTEM_EXCEPTION:{
      ...
      Fibber_StringSeq_Append(&p->ss,
			      (Fibber_String) ILU_C_Strdup("system exception"),NULL);
      Fibber_StringSeq_Append(&p->ss, (Fibber_String) ILU_C_Strdup(buf),NULL);
    break;
    }
  default:
		     ...
		     ILU_C_ENVIRONMENT * Env)
{
  ...
  if (n < 2) {
	...
	Fibber_StringSeq_Append(&p1.ss,
				(Fibber_String) ILU_C_Strdup(buf),NULL);
      }
      if (p2.ss._length == 0) {
	...
	Fibber_StringSeq_Append(&p2.ss,
      ...
      ssp = Fibber_StringSeq_Create(p1.ss._length + p2.ss._length + 3,
				    NULL);
      Fibber_StringSeq_Append(ssp, ILU_C_Strdup("["),NULL);
      Fibber_StringSeq__CatMaybeCopy(ssp, p1.ss, 0);
      Fibber_StringSeq_Append(ssp, ILU_C_Strdup("and"),NULL);
