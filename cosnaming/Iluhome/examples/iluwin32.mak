...
SUBDIRECTORIES= timeit.dir test1.dir test2.dir httest.dir iiop.dir tutorial.dir \
	cpp2foo.dir pickle.dir javatest1.dir ngtest.dir hello-world.dir 

CLEANSUBS= timeit.clean test1.clean test2.clean httest.clean iiop.clean tutorial.clean \
	cpp2foo.clean pickle.clean javatest1.clean ngtest.clean hello-world.clean

ISLDIR=-I¡¡./;$(ILUHOME)/interfaces
################################################################################
...
$(SUBDIRECTORIES) :
	cd $*
	nmake -f iluwin32.mak CFG="$(CFG)" ISLDIR="$(ISLDIR)"
	cd ..
