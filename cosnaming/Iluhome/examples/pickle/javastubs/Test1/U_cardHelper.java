// javastubs/Test1/U_cardHelper.java
// Stubs for "Test1"
//
 ...
 * An ILU helper class.
 */
public class U_cardHelper implements xerox.ilu.IluIOFunctions  {
    private final static java.lang.String _id = 
        "ilut:ixsFWakqvxR1M-2ubK-DQZWKIAB";
    private static xerox.ilu.IluTypeCode _tc = null;
    static {
        xerox.ilu.IluPreLoad.checkStubConsistency13("v2 (2.0beta1)");
        RHelper.id();
        O5Helper.id();
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new U_cardHelper(), org.omg.CORBA.TCKind.tk_union);
    }
    ...
    public static void insert(org.omg.CORBA.Any _any, U_card _x) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        _ia.assign(_tc, _x);
    } //insert 

    public static U_card extract(org.omg.CORBA.Any _any) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
    ...
    public static xerox.ilu.IluPickle to_pickle(U_card _x) throws org.omg.CORBA.SystemException {
        int _sz = 0;
        xerox.ilu.IluCall _call = null;
        xerox.ilu.IluPickle _pickle = new xerox.ilu.IluPickle();
        try {
            _call = _pickle.startToPickle();
            _sz = U_cardHelper._szFunc(_call, _x);
            _pickle.midToPickle(_call, _sz, id());
            U_cardHelper._outFunc(_call, _x);
        } finally {
    ...
    public static U_card from_pickle(xerox.ilu.IluPickle _pickle) throws org.omg.CORBA.SystemException {
        U_card _x = null;
        xerox.ilu.IluCall _call = null;
        try {
            _call = _pickle.startFromPickle(id());
            _x = U_cardHelper._inFunc(_call);
        } finally {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        U_card _xx = ((U_card)_x);
        return U_cardHelper._szFunc(_call, _xx);
    } //szFunc 
    ...
    public static void _outFunc(xerox.ilu.IluCall _call, U_card _a) 
        throws org.omg.CORBA.SystemException
    {
        if (!_a._init) {throw new org.omg.CORBA.BAD_OPERATION();}
        _call.outUnion((int)_a._dis, xerox.ilu.IluTypeKind.cardinal_tk);
        switch(_a._dis) {
            case 0:
    ...
    public static U_card _inFunc(xerox.ilu.IluCall _call) 
        throws org.omg.CORBA.SystemException
    {
        U_card _v = null;
        int _d;
        _d = (int)_call.inUnion(xerox.ilu.IluTypeKind.cardinal_tk);
        switch(_d) {
            case 0:
                _v = U_card.alloc_R(_d, TheRHelper._inFunc(_call));
                break;
            case 1:
                _v = U_card.alloc_O5(_d, (O5) _call.inObject(false, O5Stub.iluClass()));
                break;
            default:
              _call.endUnion();
    ...
    static {
        ...
        __t = xerox.ilu.IluTypeRep.registerUnionType(
            ...
            "Test1", //islIfName
            null, //islIfBrand
            "ilut:ixsFWakqvxR1M-2ubK-DQZWKIAB", //uid
            "ilut:a9utKC9pScVOm5pXhcjtN2yJ5nO", //discriminatUID
            2, //cnt
            -1, //defaultArm
            false, //othersAllowed
            xerox.ilu.IluConstantValueKind.shortcardinal_cvk); //valueKind
        U_cardHelper.id(); //loads helper class
        _ivals = new int[1];
        _ivals[0] = (short)0;
