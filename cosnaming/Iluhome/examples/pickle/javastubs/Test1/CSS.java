...
public final class CSS { 
    ...
    public static int _szFunc(xerox.ilu.IluCall _call, java.lang.String[] _v)
                throws org.omg.CORBA.SystemException {
        int _sz = _call.szSequence(_v.length, 0);
        for (int _i = 0; _i < _v.length; _i++) {
            _sz += _call.szString8(_v[_i], 0);
        }
        _call.endSequence();
        return _sz;
    } //_szFunc

    public static void _outFunc(xerox.ilu.IluCall _call, java.lang.String[] _v)
                throws org.omg.CORBA.SystemException {
        _call.outSequence(_v.length, 0);
        for (int _i = 0; _i < _v.length; _i++) {
            _call.outString8(_v[_i], 0);
        }
        _call.endSequence();
    } //_outFunc

    public static java.lang.String[] _inFunc(xerox.ilu.IluCall _call)
            throws org.omg.CORBA.SystemException {
        int _ln = _call.inSequence(0);
        java.lang.String[] _v = new java.lang.String[_ln];
        for (int _i = 0; _i < _ln; _i++) {
            _v[_i] = _call.inString8(0);
        }
        _call.endSequence();
        return _v;
    } //_inFunc
    ...
    static{
        xerox.ilu.IluTypeRep.registerSequenceType(
            ...
            "Test1", //islIfName
            null, //islIfBrand
            "ilut:f-6N-TJeDtWrjsoVoolxLZVOEJy", //uid
