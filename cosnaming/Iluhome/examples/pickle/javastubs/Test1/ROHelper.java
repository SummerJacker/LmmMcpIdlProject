 ...
 * An ILU helper class.
 */
public class ROHelper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        RHelper.id();
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new ROHelper(), org.omg.CORBA.TCKind.tk_null);
    }
    ...
    public static xerox.ilu.IluPickle to_pickle(TheR _x) throws org.omg.CORBA.SystemException {
        ...
        try {
            ...
            _sz = ROStub._szFunc(_call, _x);
            _pickle.midToPickle(_call, _sz, id());
            ROStub._outFunc(_call, _x);
        } finally {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        TheR _xx = ((TheR)_x);
        return ROStub._szFunc(_call, _xx);
    } //szFunc 
