...
public class TheU implements java.io.Serializable {
    ...
    public static TheU alloc_O5(short _dis, O5 _v)
            throws org.omg.CORBA.BAD_OPERATION {
        TheU _res = new TheU();
        _res.set_O5(_dis, _v);
        return _res;
    ...
    public static TheU alloc_O5(O5 _v)
            throws org.omg.CORBA.BAD_OPERATION {
        return alloc_O5((short)3, _v);
    } //alloc_O5
    ...
    public void set_O5(short _d, O5 _v)
            throws org.omg.CORBA.BAD_OPERATION {
        switch (_d) {
            case (short)3:
                break;
    ...
    public static TheU alloc_OO(short _dis, O5 _v)
            throws org.omg.CORBA.BAD_OPERATION {
        TheU _res = new TheU();
        _res.set_OO(_dis, _v);
        return _res;
    ...
    public static TheU alloc_OO(O5 _v)
            throws org.omg.CORBA.BAD_OPERATION {
    ...
    public void set_OO(short _d, O5 _v)
            throws org.omg.CORBA.BAD_OPERATION {
        switch (_d) {
            case (short)4:
                break;
