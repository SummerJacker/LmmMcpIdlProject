 ...
 * An ILU helper class.
 */
public class O5Helper implements xerox.ilu.IluIOFunctions  {
    ...
    static {
        ...
        _tc = xerox.ilu.IluTypeCode.newTypeCode(id(), new O5Helper(), org.omg.CORBA.TCKind.tk_objref);
    }
    ...
    public static void insert(org.omg.CORBA.Any _any, O5 _x) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
        _ia.assign(_tc, _x);
    } //insert 

    public static O5 extract(org.omg.CORBA.Any _any) throws org.omg.CORBA.SystemException {
        xerox.ilu.IluAny _ia = (xerox.ilu.IluAny) _any;
    ...
    public static xerox.ilu.IluPickle to_pickle(O5 _x) throws org.omg.CORBA.SystemException {
        int _sz = 0;
        xerox.ilu.IluCall _call = null;
        xerox.ilu.IluPickle _pickle = new xerox.ilu.IluPickle();
        try {
            _call = _pickle.startToPickle();
            _sz = _call.szObject(_x, false, O5Stub.iluClass());
            _pickle.midToPickle(_call, _sz, id());
            _call.outObject(_x, false, O5Stub.iluClass());
        } finally {
    ...
    public static O5 from_pickle(xerox.ilu.IluPickle _pickle) throws org.omg.CORBA.SystemException {
        O5 _x = null;
        xerox.ilu.IluCall _call = null;
        try {
            _call = _pickle.startFromPickle(id());
            _x = (O5) _call.inObject(false, O5Stub.iluClass());
        } finally {
    ...
    public int szFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        O5 _xx = ((O5)_x);
        return _call.szObject(_xx, false, O5Stub.iluClass());
    } //szFunc 
    ...
    public void outFunc(xerox.ilu.IluCall _call, java.lang.Object _x, xerox.ilu.IluTypeCode _tc) throws org.omg.CORBA.SystemException {
        O5 _xx = ((O5)_x);
        _call.outObject(_xx, false, O5Stub.iluClass());
    } //outFunc 
    ...
    public boolean isAFunc(java.lang.Object _x, xerox.ilu.IluTypeCode _tc) {
        ...
        return (_x instanceof O5);
    } //isAFunc 

    static {
        Test1._allJavaStubs.load();
    }
    public static O5 narrow(java.lang.Object _x) {
        return (O5) _x;
    } //narrow 
