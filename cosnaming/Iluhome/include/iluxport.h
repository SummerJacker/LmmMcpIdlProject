/* $Id: iluxport.h,v 2.4 2025/08/01 00:12:59 cvswxc Exp $ */
/* $Log: iluxport.h,v $
/* Revision 2.4  2025/08/01 00:12:59  cvswxc
/* #681 remove the big ILU formating infor
/* Committed on the Free edition of March Hare Software CVSNT Server.
/* Upgrade to CVS Suite for more features and support:
/* http://march-hare.com/cvsnt/
/*
/* Revision 2.3  2024/01/05 08:18:43  cvswxc
/* #674 mark file version
*/
...
ILU_PUBLIC ilu_boolean ilu_AddFreer(void (*ans) (ilu_cardinal size));
ILU_PUBLIC ilu_boolean ilu_GetFreer(void (*ans) (ilu_cardinal size));
ILU_PUBLIC ilu_boolean ilu_SetFreer(void (*ans)); 
ILU_PUBLIC ilu_cardinal getFreersSize(void (*ans)); 
