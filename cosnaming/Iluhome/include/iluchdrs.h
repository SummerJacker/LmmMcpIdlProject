/* $Id: iluchdrs.h,v 2.3 2025/08/01 00:02:41 cvswxc Exp $ */
/* Last edited by Mike Spreitzer June 1, 1998 10:01 am PDT */
/*  $Log: iluchdrs.h,v $
/*  Revision 2.3  2025/08/01 00:02:41  cvswxc
/*  #681 remove the big ILU formating infor
/*  Committed on the Free edition of March Hare Software CVSNT Server.
/*  Upgrade to CVS Suite for more features and support:
/*  http://march-hare.com/cvsnt/
/*
/*  Revision 2.2  2019/12/06 07:37:36  cvswxc
/*  CORBA_ORB_ObjectIdList_Append 增加错误环境变量 #660
/*
  Revision 2.1  2015/01/24 01:56:53  cvswxc
  加入判断内存分配不成功时候的输出变量 #572
*/
...
ILU_RUNTIME_PUBLIC void
  CORBA_ORB_ObjectIdList_Append (CORBA_ORB_ObjectIdList *h, CORBA_ORB_ObjectId item, ilu_Error* err);
ILU_RUNTIME_PUBLIC void
...
ILU_RUNTIME_PUBLIC void     _ILU_C_AppendGeneric(ILU_C_Sequence h, char *p, int sz, ilu_Error *err);
/* append an element pointed at by `p' of size `sz' to `h' */

ILU_RUNTIME_PUBLIC void
_ILU_C_EveryElement(ILU_C_Sequence h,
		    void (*proc) (void *, void *, ilu_Error *),
		    int sz, void *data);
