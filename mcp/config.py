...
QT_AIR_GROUND_FORMATION_PATH: str = "/api/task/formation/air_ground"
QT_AIR_GROUND_FORMATION_STATUS_PATH: str = "/api/task/formation/air_ground/status"
QT_AIR_GROUND_FORMATION_DISBAND_PATH: str = "/api/task/formation/air_ground/disband"
